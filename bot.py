...
class BuildSteps(StatesGroup):
    ...
    instruction_part = State()  # Для отслеживания текущей части инструкции
...
# --- ХРАНИЛИЩЕ ---
last_build_data = {}
instruction_message_ids = {}  # Храним ID сообщений с инструкцией для редактирования
...
async def instruction_start(callback: CallbackQuery):
    ...
    instruction_message_ids[callback.from_user.id] = msg.message_id
    await callback.answer()
...
async def main():
    ...
    print("✅ Инструкция с кнопками 'ДАЛЕЕ' и 'НАЗАД'")
